...
r/TrueFilm on reddit community
r/TrueFilm is a community about in-depth discussions on films. People share their opinions on movies, their critiques, and immediate reactions. The posts range from analytical critique essays to emotional reactions right after a first watch, with a lot of middle ground posts that just state their opinions without arguing them. This variation in posts makes it perfect for a classification task. 

# Labels

## Critique - a structured argument about something, with specific evidence provided. The goal is to support their claim.
...
"The ending of "In a Lonely Place" (1950) succeeds where the ending of "Suspicion" (1941) fails.
...
## Opinion - a clear stance without supporting arguments. Not arguing, just asserting.
...
"Why do all teen-oriented blockbusters feel the same?
Maze Runner, Hunger Games, Divergent, I would challenge you to tell any of them apart, cause I sure as shit can't. All have the same formula, tone, general plot points, everything.

It's usually something along the lines of "In a vaguely dystopic world, (white teenage protagonist) is just a normal person, but is recruited to fight the (dystopic leaders and/or supernatural/extraterrestrial enemy) by a (school/secret society) and is trained by (insert major celebrity used for marketing purposes). They team up with a group of friends (ethnically diverse, of course) their same age to help end this horrible cause.

Protagonist oftentimes befriends the characters of the same gender and established a romance with at least one of the opposite."

I just described every single teen blockbuster ever made ever. Can you please name one that doesn't adhere to this formula? Because I just described Hunger Games, Divergent, Ender's Game, Percy Jackson, Harry Potter, Twilight, The Host, and probably some others I'm not thinking of.

I don't think there's a single genre or subgenre more formulaic than this one. Superhero movies get formulaic but you still see some twists here and there. Teen blockbusters, as far as I know, have pretty much stayed the same. I really wouldn't mind if the genre went away entirely, because even the ones that are okay really aren't much more than just that.

I really hate how studios aim things for teenagers because I have yet to see a teen blockbuster movie that wasn't completely lame. Either create movies for families (like Pixar) or make them for adults. Child protagonists can have a level of innocence and wonderment that makes them engaging, and adult characters are usually more mature. But teen characters aren't young enough to be cute, and they aren't old enough to be mature, so they almost always end up being these annoying, whiny characters stuck in an awkward middle ground. I hardly ever, ever see teenage characters that don't make me want to claw my eyes out. Hollywood has absolutely no idea how to write characters in the 13-18 age group."



## Reaction - immediate emotional response of watching a film. The post is about what the author felt, not what the film is or what the film means.
...
I will collect examples manually by browsing r/TrueFilm. I will aim for approximately 65-70 examples per label (Critique, Opinion, Reaction) to reach a balanced dataset of around 200 total. If any label is underrepresented after the initial collection, I will return to the subreddit and search specifically for that type - for example, searching "IJW" or "just watched" to find more Reaction posts, or sorting by top posts to find more Critiques.


# Evaluation Metrics

I will use overall accuracy and per-class F1 score for both models. Accuracy alone is insufficient because it hides per-label failures — a model that predicts Critique for every post could still achieve high accuracy if Critique is the majority class. Per-class F1 reveals whether the model has actually learned each boundary. I will also use a confusion matrix to identify which specific label pairs are being confused and in which direction.


# Definition of Success

I will consider the classifier successful if all three labels achieve at least 0.70 F1 on the test set, and if the fine-tuned model meaningfully outperforms the zero-shot baseline. The Critique/Opinion boundary is the most important. If the model cannot distinguish these two it has not learned the core distinction this community cares about.


# AI Tool Plan

**Label stress-testing**: Before annotating, I will give Claude my label definitions and edge case description and ask it to generate 8-10 posts that sit at the boundary between two labels. If I cannot cleanly classify the generated posts, I will tighten my definitions before starting annotation.

**Annotation assistance**: I will use an LLM to pre-label approximately half of my examples by providing it my label definitions and asking it to assign one label per post. I will manually review and correct every pre-labeled example and not just skim them. The remaining half I will label entirely myself. I will track which examples were pre-labeled and disclose this in my AI usage section.

**Failure analysis**: After training, I will paste my misclassified examples into Claude and ask it to identify common patterns, such as post length, sarcasm, or specific label pairs being confused. I will verify any patterns myself before including them in my evaluation report.